...
"
#	remoteobjects? ( ${BASE_URI}.qtremoteobjects/${PV_FULL}qtremoteobjects-documentation.7z )
...
IUSE="3d bluetooth charts datavis declarative graphicaleffects +html location
	multimedia networkauth +qch script sensors virtualkeyboard webengine purchasing remoteobjects"
